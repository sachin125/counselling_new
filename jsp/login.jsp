...
<body>
            ...
            <md-toolbar class="md-md-tall"  >
                <div class="" layout="row" >
                    <div flex="60" style="padding-left: 10%;">
                        <label style="font-size: 200%;">Counselling</label>
                    </div>
                    <div flex="40">
    ...
    <div layout="row">
        <div flex="60" style="padding:10%;color:#3f51b5;">
            <label style="font-size: 400%;font-style: italic;">Counselling</label>
            <label style="font-style: italic;">A system to find your college</label>
        </div>
        <md-content flex="40" >
